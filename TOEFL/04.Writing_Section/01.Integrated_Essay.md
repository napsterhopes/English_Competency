...
<img src="https://user-images.githubusercontent.com/12064832/206869454-c4c904ac-5275-40d0-9f68-ab45bb4fe645.png" width=600 />

---

#### Editing and self scoring/grading
Editing and grading your own essay is crucial.
Editing your essay well will be the difference between a couple of points which could lead to the score that you want in the Writing section. 
So you're going to learn how to edit the most efficiently, efficient way possible and you're also going to learn how to grade your own essay and be able to use that
information to help you improve your writing. 

> 1. Editing your essay.

We already talked about the first 18 mins already, but the last two or more(if you can extend) minutes would be editing your essay. 
Your goal is to minimize mistakes.
How are we gonna do that? 
Well, first of all, look at your `Speaking and Writing Grading Rubric`.

1. Check for spelling errors
2. Look at capitalization and spacing. 
Here's an essay from a student and you have to edit it. What are the things that you notice immediately?

<img src="https://user-images.githubusercontent.com/12064832/206869964-2268d675-8564-4e8e-866a-4b8637432557.png" width=600 />

We notice the capitalization, spacing, and the spelling. Go through line by line and correct those.
For example, I noticed this word `influential` spelled wrong. etc.

 just  and just changing any

3. Reread the introduction : I recommend the introduction is because it's your first impression by the reader.

4. Check your articles ("a", "an", and "the")

Fixed :

<img src="https://user-images.githubusercontent.com/12064832/206870198-b27de584-4192-4501-a5e2-3e94ae953db9.png" width=600 />
